...
fn it_sets_the_longest_policy_voting_period_for_the_proposal() {
    ...
    setup
        ...
        .execute_tx(&setup.owner_address, &setup.contract, &rust_biguint!(0), |sc| {
            ...
            sc.create_permission(managed_buffer!(b"testperm3"), managed_biguint!(0), managed_address!(&sc_address), managed_buffer!(b"testendpoint"), ManagedVec::new(), ManagedVec::new());
